...
const createCustomShadow = (color) => {
  ...
  return {
    ...
    success: `0 8px 10px 0 ${alpha(palette.success.main, 0.24)}`,
    warning: `0 8px 10px 0 ${alpha(palette.warning.main, 0.24)}`,
    error: `0 8px 10px 0 ${alpha(palette.error.main, 0.24)}`
  };
};
