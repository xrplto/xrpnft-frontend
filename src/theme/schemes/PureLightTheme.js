...
const themeColors = {
    ...
    secondary: '#6E759F', // Keeping the existing secondary color
    ...
    black: '#000000', // Keeping true black
    white: '#FFFFFF', // Keeping true white
    primaryAlt: '#1976D2', // A darker shade of primary for contrast
    text: {
