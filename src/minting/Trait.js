...
export default function Trait({ trait, onRemoveTrait }) {
    ...
    return (
        ...
        >
            ...
            <Tooltip title="Remove">
                <IconButton size="small" onClick={()=>onRemoveTrait(type)} >
                    <HighlightOffOutlinedIcon fontSize="small" style={{color: '#EB5757'}} />
                </IconButton>
            </Tooltip>
        </Paper>
    );
