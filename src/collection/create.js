        ...
        <>
            ...
            <Stack spacing={1} sx={{ mt: 4, mb: 3 }}>
                ...
                <Typography variant="p3">
                    ...
                    XRPNFT.COM. 600 x 400 recommended.(Max: 10MB)
                </Typography>
                <CardWrapper>
                    <input
                        ref={fileRef2}
            ...
            <Stack spacing={2} mb={3}>
                ...
                <Typography variant="p3">
                    ...
                    Category. Once you set, you can not change Category when you
            ...
            <Stack spacing={2} mb={3}>
                ...
                <Stack spacing={1} pl={0}>
                    <Typography variant="p3">
                        <Typography variant="s2">Normal:</Typography> You can
                        mint NFTs one by one for this collection.
                    </Typography>
                    <Typography variant="p3">
                    ...
                    <Typography variant="p3">
                        <Typography variant="s2">Random:</Typography> You can
                        upload bulk NFTs and sell NFTs randomly with Mints.
                    </Typography>
                    <Typography variant="p3">
                        <Typography variant="s2">Sequence:</Typography> You can
                        upload bulk NFTs and sell NFTs sequently with Mints.
                    </Typography>
                </Stack>
                    ...
                    <>
                        <Stack spacing={1}>
                            ...
                            <Typography variant="p3" sx={{ pb: 2 }}>
                                You need to add at least 1 currency to create a
                                collection.
                            </Typography>
                        ...
                        <Stack spacing={2} sx={{ pl: 0 }}>
                            <Typography variant="p2">
                                ...
                                here. <Typography variant="s2">*</Typography>
                            </Typography>
                            <Typography variant="p3">
                                Upload .zip file contains your NFT images to
                                Google Drive and copy & paste the shared link
                                URL.
                            </Typography>
                            {/* <Typography variant='p3'>
            ...
            <Stack spacing={2} mb={3}>
                ...
                <Typography variant="p3">
                    Taxon links NFTs to this collection, NFTs minted for this
                    collection will have this Taxon in their NFTokenID field.
                    Taxon is automatically set.
                </Typography>
            ...
            <Stack spacing={2} mb={3}>
                ...
                <Stack spacing={1} pl={0}>
                    <Typography variant="p3">
                        <Typography variant="s2">Standard:</Typography> Simply
                        compare the rarest trait of each NFT(%).
                    </Typography>
                    <Typography variant="p3">
                        <Typography variant="s2">Average:</Typography> Average
                        the rarity of traits that exist on the NFT(%).
                    </Typography>
                    <Typography variant="p3">
                    ...
                    <Typography variant="p3">
                        <Typography variant="s2">Score:</Typography> Sum of the
                        Rarity Score of all of its trait values(not %, just a
                        value).
                    </Typography>
                    <Typography variant="p3">
                        <Typography variant="s2">Self:</Typography> Rarity and
                        Rank are included in each NFT metadata.
                    </Typography>
                </Stack>
            ...
            <Stack spacing={2} mb={3}>
                ...
                <Typography variant="p3">
                    Make your collection private when you need to upload NFTs or
                    do something private. You can make collection public again
                    after you've done all things.
                </Typography>
            ...
            <Stack spacing={2} mb={3}>
                ...
                <Typography variant="p3">
                    Contact support to get your own passphrase for your account.
                    Once you get your passphrase, you can use it for 10 times
                    only, if you want more, contact support again to get the new
                    passphrase.
                </Typography>
