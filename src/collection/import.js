...
export default function ImportCollection() {
    ...
    let canImport = file1 && issuer && name && slug && valid1 && valid2 && validPassword && (taxon > -1);
    ...
    const getTaxons = (issuer) => {
        ...
        axios.get(`${BASE_URL}/taxon/issuer/${issuer}`, {headers: {'x-access-account': accountAdmin, 'x-access-token': accountToken}})
        .then(res => {
            try {
    ...
    return (
        <>
            ...
            <Stack spacing={2} mb={3}>
                <Typography variant='p4'>Issuer <Typography variant='s2'>*</Typography></Typography>
                <Typography variant='p3'>Input Issuer address that you want to import collection.</Typography>
            ...
            <Stack spacing={2} mb={3}>
                <Typography variant='p4'>Taxons <Typography variant='s2'>*</Typography></Typography>
                            ...
                            <Stack key={idx}>
                                ...
                                >
                                    <Stack direction="row" spacing={2} alignItems="center">
                                        ...
                                        <Typography variant='s3' color='#33C2FF' noWrap>{tx.taxon} </Typography>
                                        <Typography variant='s4'>NFTs:</Typography>
                                        <Typography variant='s3' color='#33C2FF' noWrap>{tx.count} </Typography>
                                    </Stack>
                                </ListItemButton>
                            </Stack>
                        )
            ...
            <Stack spacing={2} mb={3}>
                ...
                <Stack spacing={1} pl={0}>
                    <Typography variant='p3'>
                        <Typography variant='s2'>Normal:</Typography> Imported collections will have Normal type.
                    </Typography>
                </Stack>
                ...
                >
                    ...
                    <ToggleButton disabled value="bulk" sx={{pl:3, pr:3}}>Bulk</ToggleButton>
                    <ToggleButton disabled value="random" sx={{pl:3, pr:3}}>Random</ToggleButton>
                    <ToggleButton disabled value="sequence" sx={{pl:3, pr:3}}>Sequence</ToggleButton>
                </ToggleButtonGroup>
